...
utc=$(date +'%:::z' | sed 's/+0//')
echo -e "$1$2TIMEZONE$5 = $3$4$timezone -$utc$5"
...
echo -e "$1$2UPTIME_SEC$5 = $3$4$uptime_sec seconds$5"

ip_address=$(ip a show enp0s3 | awk '/inet / {print $2}')
echo -e "$1$2IP$5 = $3$4$ip_address$5"

netmask=$(ipcalc $ip_address | awk '/Netmask: / {print $2}')
echo -e "$1$2NETMASK$5 = $3$4$netmask$5"

gateway_default=$(ip r | awk '/default via / {print $3}')
echo -e "$1$2GATEWAY$5 = $3$4$gateway_default$5"
...
echo -e "$1$2SPACE_USED$5 = $3$4$space_used MB$5"

space_free=$(df -k / | awk 'NR==2 {printf("%.2f", $4 / 1000)}')
echo -e "$1$2SPACE_FREE$5 = $3$4$space_free MB$5"